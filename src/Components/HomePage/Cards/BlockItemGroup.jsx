        ...
        <div className="lg:flex">
          ...
          >
            <div className="w-1/2">
              ...
              <button className="hidden lg:block bg-white px-1 py-2 rounded shadow ">Source now</button>
              </div>
          </div>
          {/* small screen title div */}
          ...
          <div className="lg:hidden block bg-white p-2">
            <button className="bg-white px-1 py-2 text-blue-600 flex items-center gap-2.5 sourcenowbtn">
              Source now
